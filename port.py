...
class PortfolioManager(QMainWindow):
    ...
    def change_theme(self):
        themes = {
            ...
            "Dark": "background-color: #2e2e2e; color: #ffffff;",
            "Blue": "background-color: #1e88e5; color: #ffffff;",
            "Green": "background-color: #43a047; color: #ffffff;"
        }

        theme, ok = QInputDialog.getItem(self, "Change Theme", "Select a theme:", list(themes.keys()), 0, False)
        if ok:
